...
description: "Learn how to create a GitHub App from a manifest with an automated web flow, covering permissions, credential retrieval, and Jenkins pipeline integration."
---
