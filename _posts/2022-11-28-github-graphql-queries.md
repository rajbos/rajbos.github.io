...
description: "Practical PowerShell examples for the GitHub GraphQL API to create and manage ProjectsV2, including authentication scopes and working with new global node IDs."
---
