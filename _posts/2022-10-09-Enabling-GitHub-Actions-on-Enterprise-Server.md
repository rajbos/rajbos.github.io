...
description: "Common gotchas when enabling GitHub Actions on GitHub Enterprise Server, covering self-hosted runners, Dependabot, GitHub Connect and binary download issues."
---
...
# Think about GitHub Actions and using them securely
I written about how to use GitHub Actions with a secure setup [here](/blog/2021/2021/12/11/GitHub-Actions-Maturity-Levels) and you can view a recording of my conference session at Code Europe 2022 [here](/blog/2022/05/30/Code-Europe).
