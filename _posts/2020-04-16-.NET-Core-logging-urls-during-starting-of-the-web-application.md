...
date: 2020-04-16
description: "Find out how to log the configured URLs of a .NET Core web application at startup using IServerAddressesFeature, with a full Serilog-based code example."
---
